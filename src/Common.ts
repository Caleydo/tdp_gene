...
export {copyNumberCat, mutationCat, unknownCopyNumberValue, unknownMutationValue} from './constants';
import {mutationCat, copyNumberCat, unknownMutationValue, unknownCopyNumberValue} from './constants';
